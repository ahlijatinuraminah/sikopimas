        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="myform">
                    ...
                    <input type="text" name="nama_isu" id="nama_isu" class="form-control" required />
                    <br />
...
<script>
    ...
    function save() {
        if ($("form")[0].checkValidity()) {
            ...
            $.ajax({
                url: "controller/controllerisu.php",
                method: "POST",
                data: objData,
                dataType:"json",  
    ...
    $(document).ready(function () {
        ...
        $("#modal_button").click(function () {
            resetForm();
            $("#modal").modal("show");
            $(".modal-title").text("Tambah Isu");
        });

        $("#tblIsu").on("click", ".update", function (e) {
            var data = table.row($(this).closest("tr")).data();
            bindForm(data);
            $("#modal").modal("show");
            $(".modal-title").text("Update Isu");            
        });
