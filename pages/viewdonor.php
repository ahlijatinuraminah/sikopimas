        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="myform">
                    ...
                    <input type="text" name="nama_donor" id="nama_donor" class="form-control" required />
                    <br />
...
<script>
    ...
    function bindForm(data) {
        $("#id").val(data.id);
        $("#nama_donor").val(data.nama_donor);
    }
    ...
    function save() {
        if ($("form")[0].checkValidity()) {
            ...
            $.ajax({
                url: "controller/controllerdonor.php",
                method: "POST",
                data: objData,
                dataType:"json",  
    ...
    $(document).ready(function () {
        ...
        $("#modal_button").click(function () {
            resetForm();
            $("#modal").modal("show");
            $(".modal-title").text("Tambah Donor");
        });

        $("#tblDonor").on("click", ".update", function (e) {
            var data = table.row($(this).closest("tr")).data();           
            bindForm(data);
            $("#modal").modal("show");
            $(".modal-title").text("Update Donor");            
        });
